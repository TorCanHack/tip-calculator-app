...
The above code snipper only renders if the value of bill, number of people and the custom percentage changes. It makes sure the value of the bill, number and percentage are not null and then gets the percentage of the total bill and then divides that tip amount by the total number of barristers, sharing the tip evenly.
